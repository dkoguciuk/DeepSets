...
class ModelNet40Downsampled(GenericDataset) : 
    ...
    def __init__(self, pointcloud_size, distance_metric, pointnet_base=''):
        ...
        # Is data present?
        if not os.path.exists(df.DATA_MODELNET40_SAMPLED_DIR + pointnet_base):
            raise AssertionError('No ModelNet40_downsampled dataset found, please move your hdf5 files into: ' + df.DATA_MODELNET40_SAMPLED_DIR + pointnet_base)
