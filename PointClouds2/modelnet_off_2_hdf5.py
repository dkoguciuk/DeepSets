...
def prepare_modelnet_40(input_dir, output_dir, point_cloud_size):
    # Is data present?
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input_dir", help="Input dir of ModelNet40 directory", type=str, required=True)
    parser.add_argument("-o", "--output_dir", help="Output dir of ModelNet40 directory", type=str, required=True)
    ...
    # Prep modelnet40
    prepare_modelnet_40(args['input_dir'], args['output_dir'], args['point_cloud_size'])
